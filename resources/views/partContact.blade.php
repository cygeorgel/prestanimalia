<div class="section landing-section">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <h2 class="text-center title">Rejoignez-nous.</h2>


            <h4 class="text-center description">Tenté de rejoindre notre concept ? Complétez notre formulaire de contact pour obtenir le programme détaillé des stages, les dates des prochaines sessions, un devis pour la formation.<br />
